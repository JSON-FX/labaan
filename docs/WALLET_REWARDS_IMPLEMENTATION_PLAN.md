...
- [ ] Build wallet, top-up, sponsor, reward, and Shop operational dashboards.
  - [x] Add a web-only super-admin foundation with business KPIs, searchable
        ...
        adjustments.
  - [x] Add a bounded super-admin Shop fulfillment runner using the existing
        leased, idempotent delivery/retry/review commands. Provider settlement
        remains webhook-authoritative and is deliberately not manually replayed.
